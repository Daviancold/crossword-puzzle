...
export const TextWithButton: React.FC<ITextPage> = ({
  ...
  return (
    <>
      ...
      <div className="absolute top-1/2 left-1/2 w-full max-w-[90%] md:max-w-l lg:max-w-xl px-4 transform -translate-x-1/2 -translate-y-1/2 text-center font-bold underline z-10">
        <h1
